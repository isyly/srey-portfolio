...
export default function ContentList({
  ...
  return (
    <div ref={component}>
      <ul
        className="grid border-b border-b-sky-100"
            ...
            {isFilled.keyText(item.data.title) && (
              ...
              >
                <Link
                  ...
                  className="flex flex-col justify-between border-t border-t-sky-100 py-10 text-sky-200 md:flex-row"
